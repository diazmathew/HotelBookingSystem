...
<div class="flex" x-data="{ sidebarOpen: false }">
    ...
    <aside
        ...
        <nav class="mt-4 flex-1 overflow-y-auto">
            ...
            <a href="{{ route('room_types.index') }}" class="{{ $navLink(request()->routeIs('room_types.*')) }}">
                <span>Room Types</span>
            </a>

            <a href="{{ route('admin.bookings') }}" class="{{ $navLink(request()->routeIs('admin.bookings')) }}">
                <span>Bookings</span>
            </a>

            <a href="{{ route('admin.users') }}" class="{{ $navLink(request()->routeIs('admin.users')) }}">
                <span>Users</span>
            </a>

            <a href="{{ route('admin.reports') }}" class="{{ $navLink(request()->routeIs('admin.reports')) }}">
                <span>Reports</span>
            </a>
