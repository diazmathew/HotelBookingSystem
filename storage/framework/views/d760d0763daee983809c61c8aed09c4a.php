...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div
        x-data="countUp(<?php echo e(\App\Models\RoomType::count()); ?>)"
        x-init="start()"
    ...
    <div
        x-data="countUp(<?php echo e(\App\Models\Booking::count()); ?>)"
        x-init="start()"
    ...
    <div
        x-data="countUp(<?php echo e(\App\Models\User::where('role','user')->count()); ?>)"
        x-init="start()"
    ...
    <div
        x-data="countUp(<?php echo e(\App\Models\Booking::where('status','Pending')->count()); ?>)"
        x-init="start()"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\1\1\HotelBookingSystem\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>